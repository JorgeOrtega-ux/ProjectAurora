...
// [NUEVO] Lógica de Rutas Dinámicas para Creator Studio
// Captura: s/channel/{view}/{uuid}
// Views permitidas: panel-control, manage-content
if (preg_match('#^s/channel/(panel-control|manage-content)/([a-f0-9\-]+)$#', $path, $matches)) {
