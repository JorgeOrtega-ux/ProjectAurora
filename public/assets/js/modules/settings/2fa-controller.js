...
// Variable para guardar la instancia del QR (opcional, por si se necesitara en el futuro)
...
export const TwoFactorController = {
    init: () => {
        ...
        // Verificar si el contenedor ya está deshabilitado por el servidor
    ...
    try {
        ...
        if (res.success && res.otpauth_url) {
            ...
            if (window.QRCodeStyling) {
                // Crear instancia con colores ESTÁTICOS (Negro sobre Blanco)
