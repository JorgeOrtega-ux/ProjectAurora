// public/assets/js/modules/social/notifications-manager.js
...
function renderNotifications(notifs) {
    ...
    notifs.forEach(n => {
        ...
        // Manejo especial para notificaciones de sistema/admin
        let avatarHtml;
        if (n.type === 'admin_alert' || n.type === 'system') {
             ...
             // [MODIFICADO] Added data-img-type="user" for fallback
             avatarHtml = avatar ? `<img src="${avatar}" class="notif-avatar" data-img-type="user">` : `<span class="material-symbols-rounded notif-default-icon">person</span>`;
        }
