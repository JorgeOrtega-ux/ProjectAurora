...
export function initAuthController() {
    ...
    document.body.addEventListener('click', async (e) => {
        ...
        if (btnNext2) {
            ...
            if(!username) { 
                // CORRECCIÓN PREVIA: Usar el botón directamente
        ...
        if (btnResend) {
            ...
            // MODIFICACIÓN: Definir dónde queremos mostrar el error (debajo del botón Finish)
            ...
            try {
                ...
                if (res.success) {
                    ...
                    // Usamos targetErrorNode en lugar de btnResend
