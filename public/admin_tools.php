...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'test_bridge') {
        ...
        if (!$fp) {
            ...
            // [CORRECCIÓN DE SEGURIDAD] Recuperar el secreto del entorno
            // Esto asegura que la prueba manual use la misma contraseña que el resto del sistema
            $bridgeSecret = $_ENV['BRIDGE_SECRET'] ?? getenv('BRIDGE_SECRET') ?? 'default_secret';

            // Enviar payload de prueba INCLUYENDO EL TOKEN
            $testPayload = json_encode([
                'auth_token' => $bridgeSecret, // <--- Token de autenticación agregado
                'target_id' => 'global',
            ...
            $bridgeResult = [
                ...
                'msg' => 'El socket aceptó la conexión y el payload fue enviado con autenticación.',
            ...
            <div class="component-card component-card--column">
                ...
                <div class="w-100">
                    <p style="font-size:13px; color:#666; margin-bottom:15px;">
                        Esta herramienta intenta abrir una conexión TCP al puerto <strong>8081</strong> (local) y enviar una notificación global de prueba usando el <strong>Token de Seguridad</strong> configurado en el servidor.
                    </p>
