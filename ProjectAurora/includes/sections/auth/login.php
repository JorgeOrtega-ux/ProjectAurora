    ...
    <div class="section-center-wrapper">
        <div class="form-container">
            ...
            <div data-step="login-1" class="auth-step-container <?php echo $isStep2 ? '' : 'active'; ?>">
                <h1 data-i18n="auth.login.title"><?php echo trans('auth.login.title'); ?></h1>
                <p data-i18n="auth.login.subtitle"><?php echo trans('auth.login.subtitle'); ?></p>
                ...
                <div class="floating-label-group">
                    <input 
                        ...
                        placeholder=" "
                    >
                    <label class="floating-label" data-i18n="auth.login.password_label"><?php echo trans('auth.login.password_label'); ?></label>
            ...
            <div data-step="login-2" class="auth-step-container <?php echo $isStep2 ? 'active' : ''; ?>">
                <div class="auth-back-link">
                    <a href="#" data-action="login-2fa-back" style="color:#666; text-decoration:none; display:flex; align-items:center; gap:5px; font-size:14px;">
                        ...
                        <span data-i18n="global.cancel"><?php echo trans('global.cancel'); ?></span>
                    </a>
                </div>

                <h1 data-i18n="auth.2fa.title"><?php echo trans('auth.2fa.title'); ?></h1>
                <p data-i18n="auth.2fa.subtitle"><?php echo trans('auth.2fa.subtitle'); ?></p>
                
                <p style="font-size:14px; margin-top:10px;">
                    <span data-i18n="auth.2fa.instruction"><?php echo trans('auth.2fa.instruction'); ?></span> 
                ...
                <div class="floating-label-group">
                    ...
                    >
                    <label class="floating-label" data-i18n="auth.2fa.label"><?php echo trans('auth.2fa.label'); ?></label>
                </div>
