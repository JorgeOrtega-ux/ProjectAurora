        ...
        <div class="form-container">
            ...
            <div id="step-container-1" style="display: <?php echo ($initialStep === 1) ? 'block' : 'none'; ?>;">
                ...
                <div class="floating-label-group">
                    <input 
                        ...
                        minlength="8"
                    >
                    <label for="reg-password" class="floating-label">Contraseña (Mín. 8 caracteres)</label>
            ...
            <div id="step-container-2" style="display: <?php echo ($initialStep === 2) ? 'block' : 'none'; ?>;">
                ...
                <div class="floating-label-group">
                    ...
                    >
                    <label for="reg-username" class="floating-label">Usuario (8-32 letras, núm, _)</label>
