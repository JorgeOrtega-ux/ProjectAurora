...
<div class="section-content active" data-section="settings/2fa-setup">
    <div class="component-wrapper">
        ...
        <div class="component-header-card">
            <h1 class="component-page-title" data-i18n="auth.2fa.title"><?php echo trans('auth.2fa.title'); ?></h1>
            <p class="component-page-description" data-i18n="settings.security.2fa_desc"><?php echo trans('settings.security.2fa_desc'); ?></p>
        </div>
                ...
                <div class="component-card__content" style="flex-direction: column; align-items: flex-start; gap: 16px;">
                    ...
                    <div class="component-card__actions w-100" style="justify-content: flex-end; margin-top: 10px;">
                        <button type="button" class="component-button danger" data-action="disable-2fa-btn" data-i18n="settings.2fa.disable_btn">
                            <?php echo trans('settings.2fa.disable_btn'); ?>
                        </button>
                    </div>
                ...
                <div class="component-group-item component-group-item--stacked-right">
                    <div class="component-card__content">
                        ...
                        <div class="component-card__text">
                            <h2 class="component-card__title" data-i18n="settings.2fa.step1_title"><?php echo trans('settings.2fa.step1_title'); ?></h2>
                    ...
                    <div class="component-card__actions">
                        <button type="button" class="component-button primary" data-action="verify-pass-2fa" data-i18n="global.continue">
                            <?php echo trans('global.continue'); ?>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="component-card component-card--grouped disabled" data-step="2fa-step-2">
                ...
                <div class="component-group-item component-group-item--stacked">
                    <div class="component-card__content">
                        ...
                        <div class="component-card__text">
                            <h2 class="component-card__title" data-i18n="settings.2fa.step2_title"><?php echo trans('settings.2fa.step2_title'); ?></h2>
                            <p class="component-card__description" data-i18n="settings.2fa.step2_desc"><?php echo trans('settings.2fa.step2_desc'); ?></p>
                        </div>
                    </div>
                ...
                <div class="component-group-item component-group-item--stacked">
                    <div class="component-card__content">
                        ...
                        <div class="component-card__text">
                            <h2 class="component-card__title" data-i18n="settings.2fa.verify_code_title"><?php echo trans('settings.2fa.verify_code_title'); ?></h2>
                            <p class="component-card__description" data-i18n="settings.2fa.verify_code_desc"><?php echo trans('settings.2fa.verify_code_desc'); ?></p>
                        </div>
                    </div>
                    <div class="component-input-wrapper w-100">
            ...
            <div class="component-card component-card--grouped disabled" data-step="2fa-step-3">
                <div class="component-group-item component-group-item--stacked">
                    <div style="text-align: center; width: 100%; padding: 20px 0;">
                        ...
                        <h2 style="margin: 10px 0; font-size: 24px;" data-i18n="settings.2fa.success_title"><?php echo trans('settings.2fa.success_title'); ?></h2>
                        <p style="color: #666;" data-i18n="settings.2fa.success_desc"><?php echo trans('settings.2fa.success_desc'); ?></p>
                    </div>
                </div>
                ...
                <div class="component-group-item component-group-item--stacked">
                    <div class="component-card__content">
                        ...
                        <div class="component-card__text">
                            <h2 class="component-card__title" style="color: #e65100;" data-i18n="settings.2fa.backup_title"><?php echo trans('settings.2fa.backup_title'); ?></h2>
                            <p class="component-card__description" data-i18n="settings.2fa.backup_desc"><?php echo trans('settings.2fa.backup_desc'); ?></p>
                        </div>
                    </div>
