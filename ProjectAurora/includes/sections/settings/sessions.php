    ...
    <div class="component-wrapper">
        ...
        <div class="component-header-card">
            <div class="auth-back-link" style="margin-bottom: 15px; text-align: left;">
                <a href="#" onclick="event.preventDefault(); navigateTo('settings/login-security')" style="color:#666; text-decoration:none; display:flex; align-items:center; gap:5px; font-size:14px;">
