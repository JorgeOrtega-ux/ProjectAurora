<div class="module-content module-options disabled">
    <div class="menu-content">
        <div class="menu-list">
            ...
            <?php 
            // Determinar a dónde lleva el link de configuración
            $settingsTarget = $isLoggedIn ? 'settings/profile' : 'settings/preferences';
            ?>

            <div class="menu-link" data-nav="<?php echo $settingsTarget; ?>">
