        ...
        <div class="component-card component-card--grouped">
            ...
            <div class="component-group-item component-group-item--stacked">
                <div class="component-card__content">
                    ...
                    <div class="component-card__text">
                        <h2 class="component-card__title">Límite de Miembros</h2>
                        <p class="component-card__description">Establece un número máximo de integrantes. Deja en 0 para ilimitado.</p>
                    </div>
                </div>
                <div class="component-card__actions w-100">
                    <div class="component-input-wrapper w-100">
                        <input type="number" id="input-comm-max-members" class="component-text-input full-width" placeholder="0" min="0">
                    </div>
                </div>
            </div>
            ...
            <div class="component-group-item component-group-item--stacked">
                <div class="component-card__content">
                    <div class="component-icon-container" style="background-color: #e3f2fd; border-color: #90caf9;">
                        <span class="material-symbols-rounded" style="color: #1976d2;">verified</span>
                    </div>
                    <div class="component-card__text">
                        <h2 class="component-card__title">Estado de Verificación</h2>
                        <p class="component-card__description">Marca esta comunidad como oficial o verificada.</p>
                    </div>
                </div>
                <div class="component-card__actions actions-right">
                    <label class="component-toggle-switch">
                        <input type="checkbox" id="toggle-comm-verified">
            ...
            <div class="component-group-item component-group-item--stacked">
                <div class="component-card__content">
                    ...
                    <div class="component-card__text">
                        ...
                        <p class="component-card__description">Deshabilita el acceso a la comunidad temporalmente.</p>
                    </div>
                </div>
                <div class="component-card__actions actions-right">
                    <label class="component-toggle-switch">
                        <input type="checkbox" id="toggle-comm-status">
                        <span class="component-toggle-slider"></span>
                    </label>
                </div>
            </div>
            ...
            <div class="component-group-item component-group-item--stacked">
                <div class="component-card__content">
                    <div class="component-icon-container" style="background-color: #fff8e1; border-color: #ffecb3;">
                        <span class="material-symbols-rounded" style="color: #f57c00;">tag</span>
                    </div>
                    <div class="component-card__text">
                        <h2 class="component-card__title">Gestión de Canales</h2>
                        <p class="component-card__description">Crea canales de texto o voz. Puedes poner canales individuales en mantenimiento.</p>
                    </div>
                </div>
