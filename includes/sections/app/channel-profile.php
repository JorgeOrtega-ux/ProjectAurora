...
<div class="component-channel-wrapper">
    ...
    <div class="component-channel-container">
                ...
                <div>
                    <div class="component-channel-identity">
                        <h1>
                            ...
                            <span class="material-symbols-rounded component-channel-verified-icon">verified</span>
                        </h1>
                    </div>
        ...
        <div class="component-channel-tabs">
            <a href="?tab=home" class="component-channel-tab-link <?php echo $currentTab === 'home' ? 'active' : ''; ?>">Principal</a>
            <a href="?tab=videos" class="component-channel-tab-link <?php echo $currentTab === 'videos' ? 'active' : ''; ?>">Videos</a>
            <a href="?tab=shorts" class="component-channel-tab-link <?php echo $currentTab === 'shorts' ? 'active' : ''; ?>">Shorts</a>
        </div>
        ...
        <div class="component-channel-content-area" id="channel-feed-grid">
            ...
            else echo "<p class='component-channel-empty'>Error al cargar sección.</p>";
            ?>
        </div>
    </div>
</div>
