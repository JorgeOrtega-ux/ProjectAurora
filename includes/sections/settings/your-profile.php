            ...
            <div class="component-group-item" data-component="profile-picture-section">
                ...
                <div class="component-card__content">
                    <div class="component-card__profile-picture" data-element="profile-picture-preview-container" data-role="<?php echo htmlspecialchars($userRole); ?>">
                        <?php if ($pfpUrl): ?>
                            <img src="<?php echo htmlspecialchars($pfpUrl); ?>" alt="<?php echo translation('settings.profile.alt_avatar'); ?>" class="component-card__avatar-image" data-element="profile-picture-preview-image" data-img-type="user">
                        <?php else: ?>
                            <img src="" alt="<?php echo translation('settings.profile.alt_no_avatar'); ?>" class="component-card__avatar-image d-none" data-element="profile-picture-preview-image" data-img-type="user">
