...
// 2. Verificar existencia de Avatar Personalizado
$hasAvatar = false;
$avatarRelPath = '';

if (!empty($currentUser['uuid'])) {
    $avatarRelPath = 'assets/uploads/profile_pictures/' . $currentUser['uuid'] . '.png';
    // Ruta física para comprobación
    $avatarFullPath = __DIR__ . '/../../../public/' . $avatarRelPath;
    if (file_exists($avatarFullPath)) {
        $hasAvatar = true;
    }
}

// URL Final (Con timestamp para cache busting si es local)
$pfpSrc = $hasAvatar 
    ? (isset($basePath) ? $basePath : '/ProjectAurora/') . $avatarRelPath . '?v=' . time()
    : 'https://ui-avatars.com/api/?name=' . urlencode($currentUser['username']) . '&background=random&color=fff&size=128';
...
<style>
    /* Estilos base (Mismos que anterior) */
...
<div class="section-content active" data-section="settings/your-profile">
    <div class="component-wrapper">
        ...
        <div class="component-card component-card--grouped">
            ...
            <div class="component-group-item" data-component="profile-picture-section" data-has-custom="<?php echo $hasAvatar ? 'true' : 'false'; ?>">
                ...
                <div class="component-card__actions actions-right">
                    ...
                    <div class="active" data-state="profile-picture-actions-default">
                        <button type="button" class="component-button danger" 
                                ...
                                style="<?php echo $hasAvatar ? '' : 'display:none;'; ?>">
                            <span class="material-symbols-rounded">delete</span>
                        </button>
                        
                        <button type="button" class="component-button primary" data-action="profile-picture-upload-trigger">
                            <span class="material-symbols-rounded">upload</span> 
                            <span data-element="upload-btn-text"><?php echo $hasAvatar ? 'Cambiar' : 'Subir foto'; ?></span>
                        </button>
                    </div>
