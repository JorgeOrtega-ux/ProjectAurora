...
<script>
    // Lógica inline simple para el wizard (o podrías moverlo a un controller)
    async function start2FASetup() {
        ...
        try {
            // Importamos ApiService dinámicamente o usamos el global si está expuesto
            // Asumiremos que ApiService está disponible globalmente o usamos fetch directo
            // Para mantener consistencia con tu estructura, llamaremos a SettingsController si fuese necesario
            // Pero haremos fetch directo aquí replicando ApiService para no complicar imports en HTML plano
