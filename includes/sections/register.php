    ...
    <div class="auth-card">
        ...
        <?php elseif ($isStep3): ?>
            <div class="auth-header">
                <h1><?php echo $i18n->trans('auth.register.title_3'); ?></h1>
                <p><?php echo $i18n->trans('auth.register.subtitle_3'); ?> <strong><?php echo htmlspecialchars($_SESSION['pending_verification_email'] ?? ''); ?></strong>.</p>
            </div>
            ...
            <div class="form-groups-wrapper">
                <div class="form-group">
                    ...
                    <label for="verification_code" class="label-centered"><?php echo $i18n->trans('auth.register.field.code'); ?></label>
                </div>
            </div>

            <button type="button" id="btn-finish" class="btn-primary"><?php echo $i18n->trans('auth.register.btn.finish'); ?></button>
            ...
            <div class="auth-resend-wrapper" style="margin-top: 16px;">
                <a href="#" id="btn-resend-code" class="link-disabled" style="pointer-events: none; color: rgb(153, 153, 153); text-decoration: none; font-size: 14px;">
                    <?php echo $i18n->trans('auth.register.resend_code'); ?> <span id="register-timer">(60)</span>
                </a>
            </div>

        <?php elseif ($isStep2): ?>
            <div class="auth-header">
                <h1><?php echo $i18n->trans('auth.register.title_2'); ?></h1>
                <p><?php echo $i18n->trans('auth.register.subtitle_2'); ?></p>
            </div>
            ...
            <div class="form-groups-wrapper">
                <div class="form-group">
                    ...
                    <label for="username"><?php echo $i18n->trans('auth.field.username'); ?></label>
            ...
            <div style="display: flex; gap: 8px;">
                <a href="<?php echo $basePath; ?>register" data-nav="register" class="btn-primary mt-16 btn-back" style="background: #eee; color: #333; width: 40%; display:flex; justify-content:center; align-items:center; text-decoration:none;">
                    <?php echo $i18n->trans('auth.btn.back'); ?>
                </a>
                <button type="button" id="btn-next-2" class="btn-primary mt-16" style="width: 60%;">
                    <?php echo $i18n->trans('auth.btn.continue'); ?>
                </button>
            </div>

        <?php else: ?>
            <div class="auth-header">
                <h1><?php echo $i18n->trans('auth.register.title_1'); ?></h1>
                <p><?php echo $i18n->trans('auth.register.subtitle_1'); ?></p>
            </div>
            ...
            <button type="button" id="btn-next-1" class="btn-primary"><?php echo $i18n->trans('auth.btn.continue'); ?></button>

            <div class="auth-footer">
                <p>
                    <?php echo $i18n->trans('auth.has_account'); ?> 
                    <a href="<?php echo $basePath; ?>login" data-nav="login" class="link-primary"><?php echo $i18n->trans('auth.login_link'); ?></a>
                </p>
            </div>
        <?php endif; ?>
