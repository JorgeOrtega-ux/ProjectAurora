    ...
    <div class="auth-card">
        ...
        <div id="view-totp">
            ...
            <div class="form-groups-wrapper">
                <div class="form-group">
                    ...
                    <label for="2fa-code-input" style="left: 50%; transform: translateX(-50%) translateY(-50%);">Código 2FA (App)</label>
                </div>
            </div>

            <button type="button" id="btn-verify-totp" class="btn-primary">Verificar</button>
            ...
            <div class="auth-footer" style="margin-top: 15px;">
                ...
                <p><a href="<?php echo $basePath; ?>login" class="text-link">Volver al inicio de sesión</a></p>
            </div>
        </div>
        ...
        <div id="view-backup" style="display: none;">
            <div class="auth-header">
                ...
                <h1>Acceso de Recuperación</h1>
                <p>Ingresa uno de tus códigos de emergencia guardados.</p>
            </div>

            <div class="form-groups-wrapper">
                <div class="form-group">
                    <input type="text" id="2fa-backup-input" required placeholder=" " style="text-align: center; font-size: 16px;">
                    <label for="2fa-backup-input" style="left: 50%; transform: translateX(-50%) translateY(-50%); width: 100%; text-align: center;">Código de Recuperación</label>
                </div>
            </div>

            <button type="button" id="btn-verify-backup" class="btn-primary">Usar código de recuperación</button>

            <div class="auth-footer" style="margin-top: 15px;">
                <p style="margin-bottom: 8px;">
                    <a href="#" id="trigger-show-totp" class="text-link" style="color: #666; font-size: 13px;">
                        Tengo mi dispositivo (Usar App)
                    </a>
                </p>
                <p><a href="<?php echo $basePath; ?>login" class="text-link">Volver al inicio de sesión</a></p>
            </div>
